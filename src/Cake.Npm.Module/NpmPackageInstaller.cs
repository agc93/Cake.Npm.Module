...
namespace Cake.Npm.Module
{
    ...
    public class NpmPackageInstaller : IPackageInstaller
    {
        ...
        public NpmPackageInstaller(IProcessRunner processRunner, ICakeLog log, INpmContentResolver contentResolver, ICakeConfiguration config)
        {
        ...
        private static void GetSaveArguments(ProcessArgumentBuilder arguments, PackageReference definition)
        {
